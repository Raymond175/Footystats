...
class Command(BaseCommand):
    ...
    def fetch_and_save_fixtures(self):
        ...
        'Primeira Liga': 94,   # Portugal Primeira Liga
        'Allsvenskan': 113,    # Sweden Allsvenskan
        'Super Lig': 203,      # Turkey Super Lig
        'Saudi Pro League': 214,  # Saudi Arabia Pro League
        ...
        seasons = range(2013, 2025)  # From 2013 to 2023
        headers = {
    ...
    #             'status_elapsed': fixture_data['status']['elapsed'],
    #             'goals_home': item['goals']['home'],
    #             'goals_away': item['goals']['away'],
    #             'score_halftime_home': score_data['halftime']['home'],
    #             'score_halftime_away': score_data['halftime']['away'],
    #             'score_fulltime_home': score_data['fulltime']['home'],
    #             'score_fulltime_away': score_data['fulltime']['away'],
    #         }
    #     )
